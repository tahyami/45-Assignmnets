...
let people =["anas","assam","rafay"];
//console.log(people.includes("anas"));
//console.log(!people.includes("taha"));
//include is not working i dont know but why it gives error but i used differnent mehtod of checking wheather the elment is in the array or not
let has = people.some(person=>person==="taha");
console.log(has); 
